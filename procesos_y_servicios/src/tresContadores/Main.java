...
public class Main extends JFrame implements KeyListener{
	...
	public void keyPressed(KeyEvent e) {
		...
		if (e.getKeyCode() == KeyEvent.VK_2) {
			Contador0 contador0 = new Contador0(cont0, 1000);
			contador0.start(); //CONTADOR DE 1 SEG ENTRE INTERVALO
		}
		if (e.getKeyCode() == KeyEvent.VK_3) {
			Contador0 contador1 = new Contador0(cont1, 500);
			contador1.start(); //CONTADOR DE 0.5 SEG ENTRE INTERVALO
		}
		if (e.getKeyCode() == KeyEvent.VK_4) {
			Contador0 contador2 = new Contador0(cont2, 100);
			contador2.start(); //CONTADOR DE 0.1 SEG ENTRE INTERVALO
		}
		if (e.getKeyCode() == KeyEvent.VK_5) {
			Contador3 contador3 = new Contador3(cont3);
